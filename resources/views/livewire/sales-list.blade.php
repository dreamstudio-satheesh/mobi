<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    <input type="text" class="form-control" placeholder="Search by customer name, mobile, or invoice" wire:model.debounce.500ms="search">
                </div>
                <div class="col-md-2">
            ...
            <tbody>
                @forelse ($sales as $index => $sale)
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('/admin/sales/detail/' . $sale->id) }}" class="btn btn-sm btn-info">View</a>

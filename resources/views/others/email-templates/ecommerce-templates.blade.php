        ...
        <tr>
          <td>
            <table align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: left;" width="100%">
              <tbody>
                <tr>
                  <td style="text-align: center;"><img src="{{asset('assets/images/email-template/delivery-2.png')}}" alt="" style=";margin-bottom: 20px;"></td>
                </tr>
                <tr>
                  <td>
                    <p style="font-size: 14px;"><b>Hi John Doe,</b></p>
                    <p style="font-size: 14px; color:#6C757D;">Order Is Successfully Processsed And Your Order Is On The Way,</p>
                    <p style="font-size: 14px; color:#6C757D;">Transaction ID : 267676GHERT105467,</p>
                  </td>
                </tr>
              </tbody>
            </table>

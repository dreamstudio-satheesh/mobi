        ...
        <td>
          <table style="background-color: #f6f7fb; width: 100%">
            <tbody>
              <tr>
                <td>
                  <table style="width: 650px; margin: 0 auto; margin-bottom: 20px">
                    <tbody>
                      <tr>
                        <td><img src="{{ asset('assets/images/logo/logo.png') }}" alt="logo" style="height: 40px;"></td>
            ...
            <tbody>
              <tr>
                <td style="padding: 20px">
                  ...
                  <p>you forgot your password for yuri Admin. If this is true, click below to reset your password.</p>
                  <p style="text-align: center"><a href="{{ route('admin.reset-password') }}"
                      style="padding: 10px; background-color: #009DB5; color: #fff; display: inline-block; border-radius: 4px">Reset
                      Password</a></p>
          ...
          <table style="width: 650px; margin: 0 auto; margin-top: 20px">
            <tbody>
              <tr style="text-align: center">
                <td>
                  ...
                  <p style="color: #999; margin-bottom: 0">Don't Like These Emails?<a href="#!"
                      style="color: #009DB5">Unsubscribe</a></p>
                  <p style="color: #999; margin-bottom: 0">Powered By Yuri Admin</p>
                </td>
              </tr>
            </tbody>
          </table>

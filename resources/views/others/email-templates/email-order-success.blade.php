...
<html lang="en">
  ...
  <body style="margin: 20px auto;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="padding: 0 20px;background-color: #fff; -webkit-box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);width: 100%;">
      <tbody>
        <tr>
          <td>
            <table align="center" border="0" cellpadding="0" cellspacing="0">
              <tbody>
                <tr>
                  <td><img src="{{ asset('assets/images/email-template/delivery.png') }}" alt="" style=";margin-bottom: 20px;"></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><img src="{{ asset('assets/images/email-template/order-success.png') }}" alt="" style="margin-top: 20px;"></td>
                </tr>
              </tbody>
            </table>
            ...
            <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left">
              <tbody>
                ...
                <tr>
                  <td colspan="2" style="line-height: 49px;font-family: Inter;font-size: 13px;color: #000000;padding-left: 20px;text-align:left;border-right: unset;">Gift Wrapping: </td>

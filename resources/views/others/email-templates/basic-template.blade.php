                      ...
                      <tr>
                        <td style="padding: 20px">
                          ...
                          <div class="text-center"><a href="{{ route('admin.contacts') }}"
                              style="padding: 10px; background-color: #009DB5; color: #fff; display: inline-block; border-radius: 4px; margin-bottom: 18px">Call
                              To Action </a></div>
                          <p>This is a really simple email template. It's sole purpose is to get the recipient to click
